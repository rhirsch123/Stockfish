...
struct NNZInfo {
    ...
    struct NNZCursor {
        ...
        void record4(SIMD::vec_t neurons1, SIMD::vec_t neurons2,
                     SIMD::vec_t neurons3, SIMD::vec_t neurons4) {
        ...
        #else
            __m256i p1 = _mm256_packs_epi32(neurons1, neurons2);
            __m256i p2 = _mm256_packs_epi32(neurons3, neurons4);
